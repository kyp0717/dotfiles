...
- `subagent_type`: `generalPurpose`
- `model`: your configured how-explainer model (default `k3`)
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `k3`, `gpt-5.5-high-fast`, `composer-2.5-fast`), all in a single message.
